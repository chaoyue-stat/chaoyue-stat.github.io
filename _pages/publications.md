...
======
- Z. D. Zhang, **Y. Chao**, and X. J. Ma\*. Robust Distributed Learning under Least Squares Approximation. Under Review.
- Y. Z. Zhao, X. J. Ma, and **Y. Chao**\*. Spatial Lag Quantile Regression in Compositional Data. Under Review.
- Z. Q. Qin, **Y. Chao**, and X. J. Ma\*. Distributed Quadratic Interpolation Estimation for Large-Scale Quantile Regression. Under Review.
- **Y. Chao**, X. C. Xia\*, and W. Zhong. Communication-Efficient Pilot Estimation for Non-Randomly Distributed Data in Diverging Dimensions. Under Review.
- **Y. Chao**, L. Huang, and X. J. Ma\*. Decentralized ADMM-Based Optimization for Large-Scale Penalized Regression in Distirbuted Compositional Data. Under Review. 
